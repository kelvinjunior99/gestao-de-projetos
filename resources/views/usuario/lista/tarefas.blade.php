...
@section('title', 'Gestor Work - tarefas')
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card card-md border border-2 rounded-2 border-secondary">
              <div class="card-body">
                ...
                <span class="badge bg-info text-dark p-2 fw-bold mb-4">Criar api para usuarios</span>
                <ul class="list-unstyled lh-lg">
                  ...
                  <li>
                    ...
                    <li class="fw-bold"><i class="fa fa-user" aria-hidden="true"></i> 3 Membros</li>
