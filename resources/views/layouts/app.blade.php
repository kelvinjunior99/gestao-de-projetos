...
<html lang="pt-br">
  <head>
    ...
    <title>@yield('title', 'Gestor Work')</title>
    <!-- CSS files -->
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle bg-primary" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false"  >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="{{ route('cad-projeto')}}">
                        projeto
                      </a>
           ...
           @isset($membros)
           <li class="nav-item">
            <a class="nav-link bg-primary" href="{{ route('lista-membros')}}">
